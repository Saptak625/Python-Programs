#Caesar Cipher with starting letter Decryption
message_numbers=[]
print("The starting letter has to be the same in order to get a meaningful result.")
startingletter=str(input("Enter a letter to choose as your starting letter: "))
startingnum=int(ord(startingletter.lower()))
...
for letters in message_numbers:
    if isinstance(letters, int) == True:
        encryptednum=(((int(letters))-(int(shiftkey)-int(startingnum)))%26)+97
